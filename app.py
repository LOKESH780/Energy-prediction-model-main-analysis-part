...
🔎 Debug: Available Columns")
    st.write(df.columns.tolist())  # Show actual column names to find correct one
    # st.metric("Average Renewable Capacity per Capita", f"{df['Renewable_electricity_generating_capacity_per_capita'].mean():.2f}"):.2f}"):.2f}")
with col6:
